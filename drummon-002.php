...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['remove_record'])):
  ...
  unset($_SESSION['rowstoshow']); 
  header("refresh: 20; URL=".$pagename);       
endif;
...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['savedata'])) :  
  ...
  $required_fields = array('Drug','Dose', 'Time');
      ...
      if(array_key_exists($medtime, $_POST)): 
        ...
        foreach($_POST[$medtime]['record_id'] as $k => $v):
          if(empty($_POST[$medtime]['record_id'][$k])):
            ...
            $sql_insert_med_record.'<br />'
                .$_POST['patient_id'].', '
                .$_POST['patient_name'].', '
                .$medtime.', '
                .$_POST[$medtime]['Drug'][$k].', '
                .$_POST[$medtime]['Time'][$k].', '
                .$_POST[$medtime]['Dose'][$k]
                .'<br /><br />';
          ...
          if(!empty($_POST[$medtime]['record_id'][$k])):
            ...
            ,`Drug` = ?
            ,`Time` = ?
            ,`Dosforeach($_POST[$medtime]['record_id'] as $k => $v):e` = ?
            WHERE id = ?";
          ...
          endif; // if(!empty($_POST[$medtime]['record_id'][$k])):
        endforeach; // foreach($_POST[$medtime]['record_id'] as $k => $v):
      endif; // if(array_key_exists($medtime, $_POST)):  
    endforeach;
...
endif; // if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['savedata'])) :  
//////////////////////////////////////////////////// 
////////////////////////////////////////////////////     
